...
\NWtarget{nuweb?}{} $\langle\,${\itshape d p ratio}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@ftmb <- f(tmb)@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Aoffdiag}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Adiag}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape X and Z}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} \verb@"Schur_src.c"@\nobreak\ {\footnotesize {?}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@@\hbox{$\langle\,${\itshape free1way interfaces}\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Permutation}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@par <- x$par@\\
...
\mbox{}\verb@        null.value = ret$mu, alternative = alternative, method = x$method, @\\
\mbox{}\verb@        data.name = x$data.name)@\\
\mbox{}\verb@    class(RVAL) <- "htest"@\\
\mbox{}\verb@    print(RVAL)@\\
\mbox{}\verb@    invisible(RVAL)@\\
\mbox{}\verb@@\\
\mbox{}\verb@}@\\
\mbox{}\verb@summary.free1way <- function(object, alternative = c("two.sided", "less", "greater"), ...)@\\
\mbox{}\verb@{@\\
\mbox{}\verb@@\\
\mbox{}\verb@    alternative <- match.arg(alternative)@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@        parm <- seq_along(cf)@\\
\mbox{}\verb@@\\
\mbox{}\verb@    ESTIMATE <- cf[parm]@\\
\mbox{}\verb@    qSE <- qnorm(conf.level) * sqrt(diag(vcov(object)))[parm]@\\
\mbox{}\verb@    CINT <- cbind(ESTIMATE - qSE, ESTIMATE + qSE)@\\
\mbox{}\verb@    colnames(CINT) <- paste0(100 * c(1 - conf.level, conf.level), "%")@\\
\mbox{}\verb@    if (test == "Wald")@\\
\mbox{}\verb@        return(CINT)@\\
\mbox{}\verb@@\\
\mbox{}\verb@    CINT[] <- cbind(ESTIMATE - qSE * 5, ESTIMATE + qSE * 5)@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    return(CINT)@\\
\mbox{}\verb@}@\\
\mbox{}\verb@# power.free1way.test <- function()@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb?}{} $\langle\,${\itshape free1way interfaces}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@    }@\\
\mbox{}\verb@    r <- cut(y, breaks = breaks)[, drop = TRUE]@\\
...
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@power.free1way.test <- function(n = NULL, prob = NULL, alloc_ratio = 1, strata_ratio = 1, delta = NULL, sig.level = .05, power = NULL,@\\
\mbox{}\verb@                                link = c("logit", "probit", "cloglog", "loglog"),@\\
\mbox{}\verb@                                alternative = c("two.sided", "less", "greater"), nHess = 100,@\\
\mbox{}\verb@norm = TRUE,...) @\\
\mbox{}\verb@{@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@             power.free1way.test(n = n, prob = prob, alloc_ratio = alloc_ratio, strata_ratio = strata_ratio, @\\
\mbox{}\verb@                                 delta = delta, @\\
\mbox{}\verb@                                 sig.level = sig.level, link = link, alternative = alternative, @\\
\mbox{}\verb@                                 nHess = nHess, ...)$power@\\
\mbox{}\verb@             - power, interval = c(5, 1e+03), tol = tol, extendInt = "upX")$root)@\\
\mbox{}\verb@    else if (is.null(delta)) {@\\
\mbox{}\verb@        ### 2-sample only@\\
\mbox{}\verb@        stopifnot(length(alloc_ratio) == 1L)@\\
\mbox{}\verb@        delta <- uniroot(function(delta) @\\
\mbox{}\verb@            power.free1way.test(n = n, prob = prob, alloc_ratio = alloc_ratio, strata_ratio = strata_ratio,delta = delta, @\\
\mbox{}\verb@                                sig.level = sig.level, link = link, alternative = alternative, @\\
\mbox{}\verb@                                nHess = nHess, ...)$power@\\
\mbox{}\verb@            - power, @\\
...
\mbox{}\verb@                                sig.level = sig.level, link = link, alternative = alternative, @\\
\mbox{}\verb@                                ...)$power@\\
\mbox{}\verb@            - power, interval = c(1e-10, 1 - 1e-10), tol = tol, extendInt = "yes")$root@\\
\mbox{}\verb@    else if (is.null(power)) {@\\
\mbox{}\verb@@\\
\mbox{}\verb@        if (!inherits(link, "linkfun")) {@\\
\mbox{}\verb@            link <- match.arg(link)@\\
\mbox{}\verb@            link <- do.call(link, list())@\\
\mbox{}\verb@        }@\\
\mbox{}\verb@@\\
\mbox{}\verb@        ### if not given, assume continuous distribution@\\
...
\mbox{}\verb@            names(delta) <- paste0("group", LETTERS[seq_len(K)[-1]])@\\
...
\mbox{}\verb@        colnames(N) <- c("Control", names(delta))@\\
\mbox{}\verb@        he <- 0@\\
\mbox{}\verb@@\\
\mbox{}\verb@        for (i in 1:nHess) {@\\
\mbox{}\verb@            x <- as.table(array(0, dim = c(C, K, B)))@\\
\mbox{}\verb@            parm <- delta@\\
\mbox{}\verb@            for (b in seq_len(B)) {@\\
\mbox{}\verb@                h1 <- h0[,b] - matrix(delta, nrow = C, ncol = K - 1, byrow = TRUE)@\\
\mbox{}\verb@                p1 <- .p(link, h1)@\\
\mbox{}\verb@                p <- cbind(p0[,b], p1)@\\
\mbox{}\verb@                x[,,b] <- sapply(seq_len(K), function(k) @\\
\mbox{}\verb@                                 rmultinom(1, size = N[b, k], prob = c(p[1,k], diff(p[,k]))))@\\
...
\mbox{}\verb@        he <- he / nHess@\\
\mbox{}\verb@@\\
\mbox{}\verb@        alternative <- match.arg(alternative)@\\
\mbox{}\verb@        if ((length(delta) == 1L) && norm) {@\\
...
\mbox{}\verb@        }@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@    list(power = power, n = n, delta = delta, sig.level = sig.level, N = N)@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\item \verb@"Schur_src.c"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb?}{?}.}
\end{list}}
...
\item $\langle\,$free1way interfaces\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb?}{?}.}
