...
\mbox{}\verb@##1 intercepts <- c(-Inf, cumsum(parm[- bidx]), Inf)@\\
...
\mbox{}\verb@##1    prb <- pmax(1 - Ftmb[- nrow(Ftmb), , drop = FALSE], sqrt(.Machine$double.eps))@\\
\mbox{}\verb@    prb <- 1 - Ftmb[- nrow(Ftmb), , drop = FALSE]@\\
\mbox{}\verb@} else {@\\
\mbox{}\verb@##1    prb <- pmax(Ftmb[- 1L, , drop = FALSE] - @\\
\mbox{}\verb@##1                Ftmb[- nrow(Ftmb), , drop = FALSE], sqrt(.Machine$double.eps))@\\
...
\mbox{}\verb@##1    ret[-bidx] <- Reduce("+", @\\
\mbox{}\verb@##1                         lapply(1:ncol(x), @\\
\mbox{}\verb@##1                            function(j) {@\\
\mbox{}\verb@##1                                 .rcr(zu[-nrow(zu),j]) - @\\
\mbox{}\verb@##1                                 .rcr(zl[-1,j])@\\
\mbox{}\verb@##1                             })@\\
\mbox{}\verb@##1                         )@\\
\mbox{}\verb@    ret[- bidx] <- rowSums(zu[-nrow(zu),,drop = FALSE] - zl[-1,,drop = FALSE])@\\
\mbox{}\verb@    - ret@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\mbox{}\verb@##1        bstart <- log(diff(Qecdf))@\\
\mbox{}\verb@##1        start <- c(start, Qecdf[1], bstart)@\\
\mbox{}\verb@        start <- c(start, Qecdf)@\\
\mbox{}\verb@##1        start[!is.finite(start)] <- 0@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\mbox{}\verb@##1   ret <- do.call("optim", opargs)@\\
...
\mbox{}\verb@##1    par[is.finite(lwr)] <- exp(par[is.finite(lwr)])@\\
...
\mbox{}\verb@                           rightcensored = TRUE)@\\
\mbox{}\verb@##1    par[!is.finite(lwr)] <- 1@\\
\mbox{}\verb@##1    return(ret * par)@\\
\mbox{}\verb@    return(ret)@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@##1    opargs <- c(list(par = start[-fix], @\\
\mbox{}\verb@##                     fn = function(par) {@\\
...
\mbox{}\verb@##1    opargs <- c(list(par = start, fn = fn, gr = gr,@\\
\mbox{}\verb@##                     # lower = lwr, @\\
\mbox{}\verb@##                     method = "BFGS", @\\
...
\mbox{}\verb@@\\
\mbox{}\verb@##1    if(is.null(tryCatch(loadNamespace("Matrix"), error = function(e)NULL)))@\\
\mbox{}\verb@##1            stop(gettextf("%s needs package 'Matrix' correctly installed",@\\
\mbox{}\verb@##1                          "free1way"),@\\
\mbox{}\verb@##1                domain = NA)@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@        theta <- h ##1 c(h[1], log(diff(h)))@\\
