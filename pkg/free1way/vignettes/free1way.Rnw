...
\mbox{}\verb@        }@\\
\mbox{}\verb@        sAH <- try(solve(H$A, H$X))@\\
\mbox{}\verb@        if (inherits(sAH, "try-error"))@\\
\mbox{}\verb@            stop("Error computing the Hessian in free1way.test")@\\
...
\NWtarget{nuweb21a}{} $\langle\,${\itshape do optim}\nobreak\ {\footnotesize {21a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@maxit <- 100@\\
...
\mbox{}\verb@}@\\
\mbox{}\verb@if (ret$convergence)@\\
\mbox{}\verb@    stop(paste("Unsuccessful optimisation in free1way.test", ret$message))@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb21b}{21b}\NWlink{nuweb22}{, 22}.
...
\mbox{}\verb@                         ret@\\
\mbox{}\verb@                     },@\\
\mbox{}\verb@                     lower = lwr[-fix], @\\
\mbox{}\verb@                     method = "L-BFGS-B", @\\
...
\mbox{}\verb@    h0 <- .q(link, p0[-length(p0)])@\\
\mbox{}\verb@@\\
...
\item $\langle\,$do optim\nobreak\ {\footnotesize \NWlink{nuweb21a}{21a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21b}{21b}\NWlink{nuweb22}{, 22}.
}
