...
\mbox{}\verb@        RVAL <- free1way(y = y, x = g, z = st, weights = w, @\\
...
\mbox{}\verb@        RVAL <- free1way(y = y, x = g, weights = w, varnames = vn, ...)@\\
\mbox{}\verb@    }@\\
...
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@free1way.numeric <- function(y, x, z = NULL, event = NULL, weights = NULL, nbins = 0, @\\
...
\mbox{}\verb@    RVAL <- free1way(y = r, x = x, z = z, event = event, weights = weights, @\\
...
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@free1way.factor <- function(y, x, z = NULL, event = NULL, weights = NULL, @\\
\mbox{}\verb@    varnames = c(deparse1(substitute(y)), @\\
\mbox{}\verb@                 deparse1(substitute(x)), @\\
\mbox{}\verb@                 deparse1(substitute(z))), ...) {@\\
\mbox{}\verb@@\\
