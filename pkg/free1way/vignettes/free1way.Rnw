...
\NWtarget{nuweb12a}{} \verb@"Schur_src.c"@\nobreak\ {\footnotesize {12a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb36}{36}\NWlink{nuweb55}{, 55}\NWlink{nuweb56a}{, 56a}.
...
\mbox{}\verb@        names(colsums) <- paste0("group", LETTERS[seq_len(K)])@\\
...
\NWtarget{nuweb56a}{} $\langle\,${\itshape power setup}\nobreak\ {\footnotesize {56a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb56b}{} $\langle\,${\itshape estimate Fisher information}\nobreak\ {\footnotesize {56b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@he <- 0@\\
...
\NWtarget{nuweb57}{} $\langle\,${\itshape power call}\nobreak\ {\footnotesize {57}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@assign(".Random.seed", R.seed, envir = .GlobalEnv)@\\
...
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@power.free1way.test <- function(n = NULL, prob = rep.int(1, n) / n, alloc_ratio = 1, @\\
\mbox{}\verb@                                strata_ratio = 1, delta = NULL, sig.level = .05, @\\
\mbox{}\verb@                                power = NULL,@\\
\mbox{}\verb@                                link = c("logit", "probit", "cloglog", "loglog"),@\\
\mbox{}\verb@                                alternative = c("two.sided", "less", "greater"), @\\
\mbox{}\verb@                                nHess = 100, norm = TRUE,...) @\\
\mbox{}\verb@{@\\
\mbox{}\verb@@\\
...
\item \verb@"Schur_src.c"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb12a}{12a}.}
\end{list}}
...
\item $\langle\,$link2fun\nobreak\ {\footnotesize \NWlink{nuweb35}{35}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb36}{36}\NWlink{nuweb55}{, 55}\NWlink{nuweb56a}{, 56a}.
}
