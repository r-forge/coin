...
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@.shes <- function(parm, x, mu = 0, rightcensored = FALSE) {@\\
\mbox{}\verb@    @\hbox{$\langle\,${\itshape stratum prep}\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$}\verb@@\\
...
\mbox{}\verb@            xrc <- x[,,,2, drop = TRUE]@\\
\mbox{}\verb@            x <- x[,,,1, drop = TRUE]@\\
\mbox{}\verb@        } else {@\\
\mbox{}\verb@            stop("")@\\
\mbox{}\verb@        }@\\
\mbox{}\verb@    }@\\
...
\mbox{}\verb@lwr <- rep(-Inf, times = K - 1)@\\
\mbox{}\verb@for (b in seq_len(B)) {@\\
\mbox{}\verb@    if (is.null(xlist[[b]])) next();@\\
...
\mbox{}\verb@    if (!is.null(xrclist))@\\
\mbox{}\verb@        ret$negscore <- ret$negscore + .snsc(ret$par, x = xrclist, mu = mu, rightcensored = TRUE)@\\
\mbox{}\verb@if (hessian) {@\\
\mbox{}\verb@    ret$hessian <- .shes(ret$par, x = xlist, mu = mu)@\\
\mbox{}\verb@    if (!is.null(xrclist))@\\
\mbox{}\verb@        ret$hessian <- ret$hessian + .shes(ret$par, x = xrclist, mu = mu, rightcensored = TRUE)@\\
...
\mbox{}\verb@    if (!is.null(xrclist))@\\
\mbox{}\verb@        ret$residuals <- c(ret$residuals, .snsr(ret$par, x = xrclist, mu = mu, rightcensored = TRUE))@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
