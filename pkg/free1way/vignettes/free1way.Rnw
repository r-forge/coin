...
\code{kruskal.test}, \code{friedman.test}, \code{mantelhaen.test},
...
\mbox{}\verb@            warning(gettextf(paste("Jeffreys penalisation was applied in %s because initial optimisation failed with:", @\\
...
\NWtarget{nuweb28a}{} $\langle\,${\itshape Jeffreys penalisation}\nobreak\ {\footnotesize {28a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
