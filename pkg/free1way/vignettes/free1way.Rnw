...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb34}{34}\NWlink{nuweb62}{, 62}\NWlink{nuweb64}{, 64}\NWlink{nuweb66}{, 66}.
...
\NWtarget{nuweb62}{} $\langle\,${\itshape rfree1way}\nobreak\ {\footnotesize {62}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@}@\\
\mbox{}\verb@@\\
\mbox{}\verb@rfree1way <- function(n, delta = 0, alloc_ratio = 1, nblocks = 1, strata_ratio = 1, @\\
...
\mbox{}\verb@    ret$y <- .rfree1way(nrow(ret), delta = c(0, delta)[ret$trt], link = link)@\\
\mbox{}\verb@    return(ret)@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\NWtarget{nuweb64}{} $\langle\,${\itshape r2dsim}\nobreak\ {\footnotesize {64}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@            prb <- c(p[1,k], diff(p[,k]))@\\
\mbox{}\verb@#            unclass(cut(runif(colsums[k]), breaks = c(-Inf, cumsum(prb / sum(prb)))))@\\
\mbox{}\verb@            rmultinom(1L, size = colsums[k], @\\
\mbox{}\verb@                      prob = prb / sum(prb))@\\
\mbox{}\verb@        })@\\
...
\NWtarget{nuweb65}{} $\langle\,${\itshape random seed}\nobreak\ {\footnotesize {65}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb66}{} $\langle\,${\itshape power setup}\nobreak\ {\footnotesize {66}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb67a}{} $\langle\,${\itshape estimate Fisher information}\nobreak\ {\footnotesize {67a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@he <- 0@\\
...
\NWtarget{nuweb67b}{} $\langle\,${\itshape power call}\nobreak\ {\footnotesize {67b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb67c}{} $\langle\,${\itshape power htest output}\nobreak\ {\footnotesize {67c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb68}{} $\langle\,${\itshape power}\nobreak\ {\footnotesize {68}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item $\langle\,$estimate Fisher information\nobreak\ {\footnotesize \NWlink{nuweb67a}{67a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb68}{68}.}
...
\item $\langle\,$link2fun\nobreak\ {\footnotesize \NWlink{nuweb33}{33}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34}{34}\NWlink{nuweb62}{, 62}\NWlink{nuweb64}{, 64}\NWlink{nuweb66}{, 66}.
}
...
\item $\langle\,$power\nobreak\ {\footnotesize \NWlink{nuweb68}{68}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$power call\nobreak\ {\footnotesize \NWlink{nuweb67b}{67b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb68}{68}.}
\item $\langle\,$power htest output\nobreak\ {\footnotesize \NWlink{nuweb67c}{67c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb68}{68}.}
\item $\langle\,$power setup\nobreak\ {\footnotesize \NWlink{nuweb66}{66}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb68}{68}.}
...
\item $\langle\,$random seed\nobreak\ {\footnotesize \NWlink{nuweb65}{65}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb68}{68}.}
