...
\mbox{}\verb@    @\hbox{$\langle\,${\itshape density prob ratio}\nobreak\ {\footnotesize \NWlink{nuweb4a}{4a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@    ret <- rowSums(zu - zl) / rowSums(x)@\\
...
\NWtarget{nuweb9}{} $\langle\,${\itshape table2list}\nobreak\ {\footnotesize {9}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@        }@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@    nn <- !sapply(xlist, is.null)@\\
\mbox{}\verb@    ret <- list(xlist = xlist[nn])@\\
\mbox{}\verb@    if (!is.null(xrc))@\\
\mbox{}\verb@        ret$xrclist <- xrclist[nn]@\\
\mbox{}\verb@    ret$strata <- nn@\\
\mbox{}\verb@    ret@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\NWtarget{nuweb10a}{} $\langle\,${\itshape stratum prep}\nobreak\ {\footnotesize {10a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb10b}{10b}\NWlink{nuweb10c}{c}\NWlink{nuweb11}{, 11}\NWlink{nuweb12}{, 12}.
...
\NWtarget{nuweb10b}{} $\langle\,${\itshape stratified negative logLik}\nobreak\ {\footnotesize {10b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb10c}{} $\langle\,${\itshape stratified negative score}\nobreak\ {\footnotesize {10c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb11}{} $\langle\,${\itshape stratified negative score residual}\nobreak\ {\footnotesize {11}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@    for (b in seq_len(B)) {@\\
\mbox{}\verb@        H <- .hes(c(beta, intercepts[[b]]), x[[b]], mu = mu)@\\
\mbox{}\verb@        if (!is.null(xrc)) {@\\
\mbox{}\verb@            Hrc <- .hes(c(beta, intercepts[[b]]), xrc[[b]], mu = mu, @\\
\mbox{}\verb@                        rightcensored = TRUE)@\\
\mbox{}\verb@            H$X <- H$X + Hrc$X@\\
\mbox{}\verb@            H$A <- H$A + Hrc$A@\\
\mbox{}\verb@            H$Z <- H$Z + Hrc$Z@\\
\mbox{}\verb@        }@\\
\mbox{}\verb@        ret <- ret + (H$Z - crossprod(H$X, solve(H$A, H$X)))@\\
\mbox{}\verb@    }@\\
\mbox{}\verb@    ret@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb13}{} \verb@"linkfun.R"@\nobreak\ {\footnotesize {13}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb14}{} $\langle\,${\itshape linkfun}\nobreak\ {\footnotesize {14}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb15}{} $\langle\,${\itshape logit}\nobreak\ {\footnotesize {15}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb16}{} $\langle\,${\itshape loglog}\nobreak\ {\footnotesize {16}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb17}{} $\langle\,${\itshape cloglog}\nobreak\ {\footnotesize {17}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb18}{} $\langle\,${\itshape probit}\nobreak\ {\footnotesize {18}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb19a}{} \verb@"free1way.R"@\nobreak\ {\footnotesize {19a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb19b}{} $\langle\,${\itshape setup}\nobreak\ {\footnotesize {19b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,${\itshape table2list}\nobreak\ {\footnotesize \NWlink{nuweb9}{9}}$\,\rangle$}\verb@@\\
\mbox{}\verb@C <- dim(x)[1L]@\\
\mbox{}\verb@K <- dim(x)[2L]@\\
\mbox{}\verb@B <- dim(x)[3L]@\\
\mbox{}\verb@xl <- .table2list(x)@\\
\mbox{}\verb@xlist <- xl$xlist@\\
\mbox{}\verb@xrclist <- xl$xrclist@\\
\mbox{}\verb@if (NS <- is.null(start))@\\
\mbox{}\verb@    start <- rep.int(0, K - 1)@\\
\mbox{}\verb@lwr <- rep(-Inf, times = K - 1)@\\
\mbox{}\verb@for (b in seq_len(length(xlist))) {@\\
\mbox{}\verb@    lwr <- c(lwr, -Inf, rep.int(tol, times = nrow(xlist[[b]]) - 2L))@\\
\mbox{}\verb@    if (NS) {@\\
...
\NWtarget{nuweb20}{} $\langle\,${\itshape profile}\nobreak\ {\footnotesize {20}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@                     p[-fix] <- par@\\
\mbox{}\verb@                     ret <- .snll(p, x = xlist, mu = mu)@\\
\mbox{}\verb@                     if (!is.null(xrclist))@\\
\mbox{}\verb@                         ret <- ret + .snll(p, x = xrclist, mu = mu, rightcensored = TRUE)@\\
\mbox{}\verb@                     ret@\\
\mbox{}\verb@                 },@\\
...
\mbox{}\verb@                     p[fix] <- beta@\\
\mbox{}\verb@                     p[-fix] <- par@\\
\mbox{}\verb@                     ret <- .snsc(p, x = xlist, mu = mu)[-fix]@\\
\mbox{}\verb@                     if (!is.null(xrclist))@\\
\mbox{}\verb@                         ret <- ret + .snsc(p, x = xrclist, mu = mu, rightcensored = TRUE)[-fix]@\\
\mbox{}\verb@                     ret@\\
\mbox{}\verb@                 },@\\
...
\NWtarget{nuweb21}{} $\langle\,${\itshape optim}\nobreak\ {\footnotesize {21}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@                     if (!is.null(xrclist))@\\
\mbox{}\verb@                         ret <- ret + .snll(par, x = xrclist, mu = mu, rightcensored = TRUE)@\\
\mbox{}\verb@                     ret@\\
\mbox{}\verb@                 },@\\
\mbox{}\verb@                 gr = function(par) {@\\
\mbox{}\verb@                     ret <- .snsc(par, x = xlist, mu = mu)@\\
\mbox{}\verb@                     if (!is.null(xrclist))@\\
\mbox{}\verb@                         ret <- ret + .snsc(par, x = xrclist, mu = mu, rightcensored = TRUE)@\\
\mbox{}\verb@                     ret@\\
\mbox{}\verb@                 },@\\
...
\NWtarget{nuweb22}{} $\langle\,${\itshape post processing}\nobreak\ {\footnotesize {22}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@    if (!is.null(xrclist))@\\
\mbox{}\verb@        ret$negscore <- ret$negscore + .snsc(ret$par, x = xrclist, mu = mu, rightcensored = TRUE)[parm]@\\
\mbox{}\verb@if (hessian) {@\\
\mbox{}\verb@    ret$hessian <- .shes(ret$par, x = xlist, mu = mu, xrc = xrclist)@\\
...
\mbox{}\verb@    if (!is.null(xrclist)) {@\\
\mbox{}\verb@        rcr <- .snsr(ret$par, x = xrclist, mu = mu, rightcensored = TRUE)@\\
\mbox{}\verb@        ret$residuals <- c(rbind(matrix(ret$residuals, nrow = C),@\\
...
\mbox{}\verb@ret$mu <- mu@\\
\mbox{}\verb@ret$strata <- xl$strata@\\
...
\NWtarget{nuweb23}{} $\langle\,${\itshape ML estimation}\nobreak\ {\footnotesize {23}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb35}{35}\NWlink{nuweb36}{, 36}.
...
\NWtarget{nuweb27c}{} $\langle\,${\itshape LRT}\nobreak\ {\footnotesize {27c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@par <- x$par@\\
...
\NWtarget{nuweb28a}{} $\langle\,${\itshape Rao}\nobreak\ {\footnotesize {28a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@par <- x$par@\\
...
\NWtarget{nuweb28b}{} $\langle\,${\itshape Permutation}\nobreak\ {\footnotesize {28b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@par <- x$par@\\
...
\NWtarget{nuweb29}{} $\langle\,${\itshape Strasser Weber}\nobreak\ {\footnotesize {29}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb30}{} $\langle\,${\itshape resampling}\nobreak\ {\footnotesize {30}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb32}{} $\langle\,${\itshape link2fun}\nobreak\ {\footnotesize {32}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb33}{33}\NWlink{nuweb54}{, 54}\NWlink{nuweb55b}{, 55b}.
...
\NWtarget{nuweb33}{} $\langle\,${\itshape free1way}\nobreak\ {\footnotesize {33}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb34}{} $\langle\,${\itshape free1way methods}\nobreak\ {\footnotesize {34}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb35}{} $\langle\,${\itshape free1way summary}\nobreak\ {\footnotesize {35}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb36}{} $\langle\,${\itshape free1way confint}\nobreak\ {\footnotesize {36}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb39}{} $\langle\,${\itshape free1way formula}\nobreak\ {\footnotesize {39}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@        vn <- c(vn, names(mf)[stratum])@\\
...
\mbox{}\verb@        RVAL <- free1way.test(y = y, x = g, weights = w, varnames = vn, ...)@\\
\mbox{}\verb@    }@\\
...
\NWtarget{nuweb40}{} $\langle\,${\itshape free1way numeric}\nobreak\ {\footnotesize {40}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@free1way.test.numeric <- function(y, x, z = NULL, event = NULL, weights = NULL, nbins = 0, @\\
\mbox{}\verb@    varnames = c(deparse1(substitute(y)), @\\
\mbox{}\verb@                 deparse1(substitute(x)), @\\
\mbox{}\verb@                 deparse1(substitute(z))), ...) {@\\
\mbox{}\verb@@\\
\mbox{}\verb@    cl <- match.call()@\\
...
\mbox{}\verb@    RVAL <- free1way.test(y = r, x = x, z = z, event = event, weights = weights, @\\
...
\NWtarget{nuweb41}{} $\langle\,${\itshape free1way factor}\nobreak\ {\footnotesize {41}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@free1way.test.factor <- function(y, x, z = NULL, event = NULL, weights = NULL, @\\
\mbox{}\verb@    varnames = c(deparse1(substitute(y)), @\\
\mbox{}\verb@                 deparse1(substitute(x)), @\\
\mbox{}\verb@                 deparse1(substitute(z))), ...) {@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    d <- data.frame(w = 1, y = y, x = x)@\\
\mbox{}\verb@    if (!is.null(weights)) d$w <- weights@\\
\mbox{}\verb@    if (is.null(z)) z <- gl(1, nrow(d))@\\
\mbox{}\verb@    d$z <- z @\\
\mbox{}\verb@    if (!is.null(event)) {@\\
\mbox{}\verb@        stopifnot(is.logical(event))@\\
...
\NWtarget{nuweb50}{} $\langle\,${\itshape ROC bands}\nobreak\ {\footnotesize {50}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb51}{} $\langle\,${\itshape ppplot}\nobreak\ {\footnotesize {51}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb54}{} $\langle\,${\itshape r2dsim}\nobreak\ {\footnotesize {54}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb55a}{} $\langle\,${\itshape random seed}\nobreak\ {\footnotesize {55a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb55b}{} $\langle\,${\itshape power setup}\nobreak\ {\footnotesize {55b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb56a}{} $\langle\,${\itshape estimate Fisher information}\nobreak\ {\footnotesize {56a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@he <- 0@\\
...
\mbox{}\verb@    he <- he + .free1wayML(x, link = link, mu = mu, start = parm, fix = seq_along(parm))$hessian@\\
\mbox{}\verb@}@\\
...
\NWtarget{nuweb56b}{} $\langle\,${\itshape power call}\nobreak\ {\footnotesize {56b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb56c}{} $\langle\,${\itshape power htest output}\nobreak\ {\footnotesize {56c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb57}{} $\langle\,${\itshape power}\nobreak\ {\footnotesize {57}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@    }@\\
\mbox{}\verb@@\\
\mbox{}\verb@    @\hbox{$\langle\,${\itshape power htest output}\nobreak\ {\footnotesize \NWlink{nuweb56c}{56c}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@    ret@\\
\mbox{}\verb@}@\\
\mbox{}\verb@@{\NWsep}
...
\item \verb@"free1way.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb19a}{19a}.}
\item \verb@"linkfun.R"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb13}{13}.}
\item \verb@"Schur.c"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb?}{?}.}
\end{list}}
...
\item $\langle\,$cumsumrev\nobreak\ {\footnotesize \NWlink{nuweb4c}{4c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
...
\item $\langle\,$estimate Fisher information\nobreak\ {\footnotesize \NWlink{nuweb56a}{56a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb57}{57}.}
\item $\langle\,$free1way\nobreak\ {\footnotesize \NWlink{nuweb33}{33}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way confint\nobreak\ {\footnotesize \NWlink{nuweb36}{36}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way factor\nobreak\ {\footnotesize \NWlink{nuweb41}{41}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way formula\nobreak\ {\footnotesize \NWlink{nuweb39}{39}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way methods\nobreak\ {\footnotesize \NWlink{nuweb34}{34}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way numeric\nobreak\ {\footnotesize \NWlink{nuweb40}{40}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$free1way summary\nobreak\ {\footnotesize \NWlink{nuweb35}{35}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$Hessian\nobreak\ {\footnotesize \NWlink{nuweb7}{7}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
...
\item $\langle\,$link2fun\nobreak\ {\footnotesize \NWlink{nuweb32}{32}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33}{33}\NWlink{nuweb54}{, 54}\NWlink{nuweb55b}{, 55b}.
}
...
\item $\langle\,$LRT\nobreak\ {\footnotesize \NWlink{nuweb27c}{27c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb27a}{27a}.}
\item $\langle\,$ML estimation\nobreak\ {\footnotesize \NWlink{nuweb23}{23}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$NCOL\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb?}{?}.}
\item $\langle\,$negative logLik\nobreak\ {\footnotesize \NWlink{nuweb3b}{3b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$negative score\nobreak\ {\footnotesize \NWlink{nuweb4b}{4b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$negative score residuals\nobreak\ {\footnotesize \NWlink{nuweb5a}{5a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$NROW\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb?}{?}.}
...
\item $\langle\,$post processing\nobreak\ {\footnotesize \NWlink{nuweb22}{22}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$power\nobreak\ {\footnotesize \NWlink{nuweb57}{57}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$power call\nobreak\ {\footnotesize \NWlink{nuweb56b}{56b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb57}{57}.}
\item $\langle\,$power htest output\nobreak\ {\footnotesize \NWlink{nuweb56c}{56c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb57}{57}.}
\item $\langle\,$power setup\nobreak\ {\footnotesize \NWlink{nuweb55b}{55b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb57}{57}.}
\item $\langle\,$ppplot\nobreak\ {\footnotesize \NWlink{nuweb51}{51}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$probit\nobreak\ {\footnotesize \NWlink{nuweb18}{18}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb13}{13}.}
\item $\langle\,$profile\nobreak\ {\footnotesize \NWlink{nuweb20}{20}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$R wcrossprod\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$ {\footnotesize {\NWtxtNoRef}.}
\item $\langle\,$r2dsim\nobreak\ {\footnotesize \NWlink{nuweb54}{54}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19a}{19a}.}
\item $\langle\,$random seed\nobreak\ {\footnotesize \NWlink{nuweb55a}{55a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb57}{57}.}
\item $\langle\,$Rao\nobreak\ {\footnotesize \NWlink{nuweb28a}{28a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb27a}{27a}.}
\item $\langle\,$resampling\nobreak\ {\footnotesize \NWlink{nuweb30}{30}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33}{33}.}
\item $\langle\,$ROC bands\nobreak\ {\footnotesize \NWlink{nuweb50}{50}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51}{51}.}
\item $\langle\,$setup\nobreak\ {\footnotesize \NWlink{nuweb19b}{19b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$statistics\nobreak\ {\footnotesize \NWlink{nuweb27a}{27a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb35}{35}\NWlink{nuweb36}{, 36}.
}
\item $\langle\,$Strasser Weber\nobreak\ {\footnotesize \NWlink{nuweb29}{29}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33}{33}.}
\item $\langle\,$stratified Hessian\nobreak\ {\footnotesize \NWlink{nuweb12}{12}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$stratified negative logLik\nobreak\ {\footnotesize \NWlink{nuweb10b}{10b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$stratified negative score\nobreak\ {\footnotesize \NWlink{nuweb10c}{10c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$stratified negative score residual\nobreak\ {\footnotesize \NWlink{nuweb11}{11}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23}{23}.}
\item $\langle\,$stratum prep\nobreak\ {\footnotesize \NWlink{nuweb10a}{10a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb10b}{10b}\NWlink{nuweb10c}{c}\NWlink{nuweb11}{, 11}\NWlink{nuweb12}{, 12}.
}
\item $\langle\,$table2list\nobreak\ {\footnotesize \NWlink{nuweb9}{9}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb19b}{19b}.}
\item $\langle\,$u vec\nobreak\ {\footnotesize \NWlink{nuweb?}{?}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb?}{?}.}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape d vec}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@d[n] = a[n];@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape u vec}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@u[0] = 1 / d[0];@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape delta vec}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape v vec}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape C_symtrisolve}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape lower wcrossprod}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape upper wcrossprod}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@for (p = 0; p < P; p++) {@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape NROW}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape NCOL}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape wcrossprod}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb?}{} $\langle\,${\itshape R wcrossprod}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
